...
fn tsmt_set_32() {
    ...
    // remove A from the tree; this should move B to depth 16, and thus insert a new entry into
...
fn tsmt_set_48() {
    ...
    // remove node B from the tree; this will move node C to depth 16, and thus insert a new
